 ...
 * - 字符串比较大小时是按照字母的ascii码来做比较的，因此可以根据此来选出最大和最小的字符串
 * - 如果最大值和最小值都有公共前缀，那么他就一定是所有字符串的公共前缀
 *
 * - 时间复杂度 O(n+m) -- m是数组的长度，m是最小值的长度
 * - 空间复杂度 O(1) -- min和max的空间，是常数
 *
 * @param {string[]} strs
 * @return {string}
 */
const _longestCommonPrefix = function (strs) {
  if (strs === null || strs.length === 0) return ''
...
const strs3 = ['dog', 'docecar', 'car']

console.log(longestCommonPrefix(strs1))
console.log(longestCommonPrefix(strs2))
console.log(_longestCommonPrefix(strs3))
